...
public class RawReadView {
    ...
    public SWIGTYPE_p_unsigned_short GetRow(int i, int i2, int i3, SWIGTYPE_p_unsigned_short sWIGTYPE_p_unsigned_short) {
        ...
        if (RawReadView_GetRow__SWIG_0 != 0) {
            return new SWIGTYPE_p_unsigned_short(RawReadView_GetRow__SWIG_0, false);
        }
        return null;
    }
    ...
    public SWIGTYPE_p_unsigned_short GetRow(int i, SWIGTYPE_p_unsigned_short sWIGTYPE_p_unsigned_short) {
        ...
        if (RawReadView_GetRow__SWIG_1 != 0) {
            return new SWIGTYPE_p_unsigned_short(RawReadView_GetRow__SWIG_1, false);
        }
        return null;
    }
    ...
    public int num_channels() {
        return GcamModuleJNI.RawReadView_num_channels(this.swigCPtr, this);
    }
