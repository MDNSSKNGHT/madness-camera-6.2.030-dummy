...
public class GcamModule {
    ...
    public static SWIGTYPE_p_std__arrayT_float_3_t ApplyColorSaturation(SWIGTYPE_p_std__arrayT_float_3_t sWIGTYPE_p_std__arrayT_float_3_t, ColorSatParams colorSatParams) {
        return new SWIGTYPE_p_std__arrayT_float_3_t(GcamModuleJNI.ApplyColorSaturation__SWIG_0(SWIGTYPE_p_std__arrayT_float_3_t.getCPtr(sWIGTYPE_p_std__arrayT_float_3_t), ColorSatParams.getCPtr(colorSatParams), colorSatParams), true);
    }
    ...
    public static boolean ApplyColorSaturation(InterleavedWriteViewU8 interleavedWriteViewU8, ColorSatParams colorSatParams, SWIGTYPE_p_gcam__Context sWIGTYPE_p_gcam__Context) {
        return GcamModuleJNI.ApplyColorSaturation__SWIG_1(InterleavedWriteViewU8.getCPtr(interleavedWriteViewU8), interleavedWriteViewU8, ColorSatParams.getCPtr(colorSatParams), colorSatParams, SWIGTYPE_p_gcam__Context.getCPtr(sWIGTYPE_p_gcam__Context));
    }
    ...
    public static void ConvertFrameMetadataToRgb(int i, FrameMetadata frameMetadata) {
        GcamModuleJNI.ConvertFrameMetadataToRgb(i, FrameMetadata.getCPtr(frameMetadata), frameMetadata);
    }
    ...
    public static float EstimateSnr(FrameMetadata frameMetadata, int i) {
        return GcamModuleJNI.EstimateSnr(FrameMetadata.getCPtr(frameMetadata), frameMetadata, i);
    }
    ...
    public static GoudaStaticMetadata GetRandomGoudaStaticMetadata(int i, int i2, int i3, int i4) {
        return new GoudaStaticMetadata(GcamModuleJNI.GetRandomGoudaStaticMetadata(i, i2, i3, i4), true);
    }
    ...
    public static boolean IsEaselNative(int i) {
        return GcamModuleJNI.IsEaselNative(i);
    }

    public static boolean IsIpuCoarseGrain(int i) {
        return GcamModuleJNI.IsIpuCoarseGrain(i);
    }

    public static boolean IsIpuFineGrain(int i) {
        return GcamModuleJNI.IsIpuFineGrain(i);
    }
    ...
    public static InterleavedImageU8 ReadJpg(SWIGTYPE_p_unsigned_char sWIGTYPE_p_unsigned_char, long j) {
        return new InterleavedImageU8(GcamModuleJNI.ReadJpg__SWIG_3(SWIGTYPE_p_unsigned_char.getCPtr(sWIGTYPE_p_unsigned_char), j), true);
    }

    public static InterleavedImageU8 ReadJpg(SWIGTYPE_p_unsigned_char sWIGTYPE_p_unsigned_char, long j, ExifMetadata exifMetadata) {
        return new InterleavedImageU8(GcamModuleJNI.ReadJpg__SWIG_2(SWIGTYPE_p_unsigned_char.getCPtr(sWIGTYPE_p_unsigned_char), j, ExifMetadata.getCPtr(exifMetadata), exifMetadata), true);
    }

    public static InterleavedImageU8 ReadJpg(String str) {
        return new InterleavedImageU8(GcamModuleJNI.ReadJpg__SWIG_1(str), true);
    }

    public static InterleavedImageU8 ReadJpg(String str, ExifMetadata exifMetadata) {
        return new InterleavedImageU8(GcamModuleJNI.ReadJpg__SWIG_0(str, ExifMetadata.getCPtr(exifMetadata), exifMetadata), true);
    }

    public static boolean ReadJpgMetadata(SWIGTYPE_p_unsigned_char sWIGTYPE_p_unsigned_char, long j, ExifMetadata exifMetadata) {
        return GcamModuleJNI.ReadJpgMetadata__SWIG_1(SWIGTYPE_p_unsigned_char.getCPtr(sWIGTYPE_p_unsigned_char), j, ExifMetadata.getCPtr(exifMetadata), exifMetadata);
    }

    public static boolean ReadJpgMetadata(String str, ExifMetadata exifMetadata) {
        return GcamModuleJNI.ReadJpgMetadata__SWIG_0(str, ExifMetadata.getCPtr(exifMetadata), exifMetadata);
    }
    ...
    public static boolean RotateJpg(SWIGTYPE_p_unsigned_char sWIGTYPE_p_unsigned_char, long j, int i, SWIGTYPE_p_p_unsigned_char sWIGTYPE_p_p_unsigned_char, long[] jArr) {
        return GcamModuleJNI.RotateJpg(SWIGTYPE_p_unsigned_char.getCPtr(sWIGTYPE_p_unsigned_char), j, i, SWIGTYPE_p_p_unsigned_char.getCPtr(sWIGTYPE_p_p_unsigned_char), jArr);
    }
    ...
    public static String SerializeDngMakernoteToString(InitParams initParams, StaticMetadata staticMetadata, ShotParams shotParams, FrameMetadata frameMetadata) {
        return GcamModuleJNI.SerializeDngMakernoteToString__SWIG_0(InitParams.getCPtr(initParams), initParams, StaticMetadata.getCPtr(staticMetadata), staticMetadata, ShotParams.getCPtr(shotParams), shotParams, FrameMetadata.getCPtr(frameMetadata), frameMetadata);
    }

    public static void SerializeDngMakernoteToString(InitParams initParams, StaticMetadata staticMetadata, ShotParams shotParams, FrameMetadata frameMetadata, SWIGTYPE_p_std__string sWIGTYPE_p_std__string) {
        GcamModuleJNI.SerializeDngMakernoteToString__SWIG_1(InitParams.getCPtr(initParams), initParams, StaticMetadata.getCPtr(staticMetadata), staticMetadata, ShotParams.getCPtr(shotParams), shotParams, FrameMetadata.getCPtr(frameMetadata), frameMetadata, SWIGTYPE_p_std__string.getCPtr(sWIGTYPE_p_std__string));
    }
    ...
    public static boolean WriteJpg(String str, InterleavedReadViewU8 interleavedReadViewU8, JpgEncodeOptions jpgEncodeOptions) {
        return GcamModuleJNI.WriteJpg__SWIG_0(str, InterleavedReadViewU8.getCPtr(interleavedReadViewU8), interleavedReadViewU8, JpgEncodeOptions.getCPtr(jpgEncodeOptions), jpgEncodeOptions);
    }

    public static boolean WriteJpg(String str, YuvReadView yuvReadView, JpgEncodeOptions jpgEncodeOptions) {
        return GcamModuleJNI.WriteJpg__SWIG_1(str, YuvReadView.getCPtr(yuvReadView), yuvReadView, JpgEncodeOptions.getCPtr(jpgEncodeOptions), jpgEncodeOptions);
    }

    public static boolean WriteJpgToMemory(SWIGTYPE_p_p_unsigned_char sWIGTYPE_p_p_unsigned_char, long[] jArr, InterleavedReadViewU8 interleavedReadViewU8, JpgEncodeOptions jpgEncodeOptions) {
        return GcamModuleJNI.WriteJpgToMemory__SWIG_0(SWIGTYPE_p_p_unsigned_char.getCPtr(sWIGTYPE_p_p_unsigned_char), jArr, InterleavedReadViewU8.getCPtr(interleavedReadViewU8), interleavedReadViewU8, JpgEncodeOptions.getCPtr(jpgEncodeOptions), jpgEncodeOptions);
    }

    public static boolean WriteJpgToMemory(SWIGTYPE_p_p_unsigned_char sWIGTYPE_p_p_unsigned_char, long[] jArr, YuvReadView yuvReadView, JpgEncodeOptions jpgEncodeOptions) {
        return GcamModuleJNI.WriteJpgToMemory__SWIG_1(SWIGTYPE_p_p_unsigned_char.getCPtr(sWIGTYPE_p_p_unsigned_char), jArr, YuvReadView.getCPtr(yuvReadView), yuvReadView, JpgEncodeOptions.getCPtr(jpgEncodeOptions), jpgEncodeOptions);
    }
    ...
    public static SWIGTYPE_p_unsigned_char copy_uint8_p(short s) {
        ...
        if (copy_uint8_p != 0) {
            return new SWIGTYPE_p_unsigned_char(copy_uint8_p, false);
        }
        return null;
    }
    ...
    public static SWIGTYPE_p_p_unsigned_char copy_uint8_p_p(SWIGTYPE_p_unsigned_char sWIGTYPE_p_unsigned_char) {
        ...
        if (copy_uint8_p_p != 0) {
            return new SWIGTYPE_p_p_unsigned_char(copy_uint8_p_p, false);
        }
        return null;
    }
    ...
    public static int getKDebiasCurveChannels() {
        return GcamModuleJNI.kDebiasCurveChannels_get();
    }

    public static int getKDebiasCurveSize() {
        return GcamModuleJNI.kDebiasCurveSize_get();
    }
    ...
    public static int getKLegacySensorIdQuaternary() {
        return GcamModuleJNI.kLegacySensorIdQuaternary_get();
    }
    ...
    public static int getKLegacySensorIdTertiary() {
        return GcamModuleJNI.kLegacySensorIdTertiary_get();
    }
    ...
    public static SWIGTYPE_p_unsigned_char new_uint8_array(int i) {
        ...
        if (new_uint8_array != 0) {
            return new SWIGTYPE_p_unsigned_char(new_uint8_array, false);
        }
        return null;
    }
    ...
    public static SWIGTYPE_p_unsigned_char new_uint8_p() {
        ...
        if (new_uint8_p != 0) {
            return new SWIGTYPE_p_unsigned_char(new_uint8_p, false);
        }
        return null;
    }
    ...
    public static SWIGTYPE_p_p_unsigned_char new_uint8_p_p() {
        ...
        if (new_uint8_p_p != 0) {
            return new SWIGTYPE_p_p_unsigned_char(new_uint8_p_p, false);
        }
        return null;
    }
    ...
    public static SWIGTYPE_p_unsigned_char uint8_p_p_value(SWIGTYPE_p_p_unsigned_char sWIGTYPE_p_p_unsigned_char) {
        ...
        if (uint8_p_p_value != 0) {
            return new SWIGTYPE_p_unsigned_char(uint8_p_p_value, false);
        }
        return null;
    }
