...
public class GcamModuleJNI {
    ...
    public static final native long AeResults_wb_get(long j, AeResults aeResults);

    public static final native void AeResults_wb_set(long j, AeResults aeResults, long j2, AwbInfo awbInfo);
    ...
    public static final native long ApplyColorSaturation__SWIG_0(long j, long j2, ColorSatParams colorSatParams);

    public static final native boolean ApplyColorSaturation__SWIG_1(long j, InterleavedWriteViewU8 interleavedWriteViewU8, long j2, ColorSatParams colorSatParams, long j3);
    ...
    public static final native void ConvertFrameMetadataToRgb(int i, long j, FrameMetadata frameMetadata);
    ...
    public static final native float DebiasParams_Point_x_get(long j, DebiasParams.Point point);

    public static final native void DebiasParams_Point_x_set(long j, DebiasParams.Point point, float f);

    public static final native float DebiasParams_Point_y_get(long j, DebiasParams.Point point);

    public static final native void DebiasParams_Point_y_set(long j, DebiasParams.Point point, float f);

    public static final native long DebiasParams_curves_get(long j, DebiasParams debiasParams);

    public static final native void DebiasParams_curves_set(long j, DebiasParams debiasParams, long j2);
    ...
    public static final native float EstimateSnr(long j, FrameMetadata frameMetadata, int i);
    ...
    public static final native float ExifMetadata_dng_baseline_exposure_shadows_weight_get(long j, ExifMetadata exifMetadata);

    public static final native void ExifMetadata_dng_baseline_exposure_shadows_weight_set(long j, ExifMetadata exifMetadata, float f);
    ...
    public static final native void ExifMetadata_thumbnail_jpg_set(long j, ExifMetadata exifMetadata, long j2);
    ...
    public static final native void Gcam_AddViewfinderFrame(long j, Gcam gcam, int i, long j2, FrameMetadata frameMetadata, long j3, SpatialGainMap spatialGainMap, long j4, AeShotParams aeShotParams, long j5, long j6, RawWriteView rawWriteView);
    ...
    public static final native boolean GeometricCalibration_DeserializeFromString(long j, GeometricCalibration geometricCalibration, long j2);
    ...
    public static final native void GeometricCalibration_SerializeToString(long j, GeometricCalibration geometricCalibration, long j2, int i);
    ...
    public static final native long GetRandomGoudaStaticMetadata(int i, int i2, int i3, int i4);
    ...
    public static final native void GoudaBlobCallback_BlobReady(long j, GoudaBlobCallback goudaBlobCallback, long j2, String str, String str2, String str3);

    public static final native long GoudaCallbacks_blob_callback_get(long j, GoudaCallbacks goudaCallbacks);

    public static final native void GoudaCallbacks_blob_callback_set(long j, GoudaCallbacks goudaCallbacks, long j2, GoudaBlobCallback goudaBlobCallback);
    ...
    public static final native long GoudaDepthArguments_front_stereo_0_get(long j, GoudaDepthArguments goudaDepthArguments);

    public static final native void GoudaDepthArguments_front_stereo_0_set(long j, GoudaDepthArguments goudaDepthArguments, long j2, InterleavedReadViewU8 interleavedReadViewU8);

    public static final native long GoudaDepthArguments_front_stereo_1_get(long j, GoudaDepthArguments goudaDepthArguments);

    public static final native void GoudaDepthArguments_front_stereo_1_set(long j, GoudaDepthArguments goudaDepthArguments, long j2, InterleavedReadViewU8 interleavedReadViewU8);

    public static final native long GoudaDepthArguments_pd_input_get(long j, GoudaDepthArguments goudaDepthArguments);

    public static final native void GoudaDepthArguments_pd_input_set(long j, GoudaDepthArguments goudaDepthArguments, long j2, InterleavedReadViewU16 interleavedReadViewU16);
    ...
    public static final native boolean GoudaRequest_colorize_debug_images_get(long j, GoudaRequest goudaRequest);

    public static final native void GoudaRequest_colorize_debug_images_set(long j, GoudaRequest goudaRequest, boolean z);
    ...
    public static final native int GoudaRequest_depth_blur_config_get(long j, GoudaRequest goudaRequest);

    public static final native void GoudaRequest_depth_blur_config_set(long j, GoudaRequest goudaRequest, int i);

    public static final native int GoudaRequest_depth_blur_layers_get(long j, GoudaRequest goudaRequest);

    public static final native void GoudaRequest_depth_blur_layers_set(long j, GoudaRequest goudaRequest, int i);
    ...
    public static final native long GoudaRequest_gouda_static_metadata_get(long j, GoudaRequest goudaRequest);

    public static final native void GoudaRequest_gouda_static_metadata_set(long j, GoudaRequest goudaRequest, long j2, GoudaStaticMetadata goudaStaticMetadata);
    ...
    public static final native boolean GoudaRequest_use_internal_rectiface_get(long j, GoudaRequest goudaRequest);

    public static final native void GoudaRequest_use_internal_rectiface_set(long j, GoudaRequest goudaRequest, boolean z);

    public static final native boolean GoudaRequest_use_learned_depth_get(long j, GoudaRequest goudaRequest);

    public static final native void GoudaRequest_use_learned_depth_set(long j, GoudaRequest goudaRequest, boolean z);

    public static final native long GoudaRequest_warpfield_get(long j, GoudaRequest goudaRequest);

    public static final native void GoudaRequest_warpfield_set(long j, GoudaRequest goudaRequest, long j2);

    public static final native long GoudaSegmenterSwigWrapper_GetSegmenterHandle(long j, GoudaSegmenterSwigWrapper goudaSegmenterSwigWrapper);

    public static final native boolean GoudaSegmenterSwigWrapper_Init(long j, GoudaSegmenterSwigWrapper goudaSegmenterSwigWrapper, long j2, long j3, String str, boolean z, boolean z2, boolean z3);

    public static final native void GoudaSegmenterSwigWrapper_Release(long j, GoudaSegmenterSwigWrapper goudaSegmenterSwigWrapper);

    public static final native long GoudaStaticMetadata_calibration_landscape_left_get(long j, GoudaStaticMetadata goudaStaticMetadata);

    public static final native void GoudaStaticMetadata_calibration_landscape_left_set(long j, GoudaStaticMetadata goudaStaticMetadata, long j2, PdCalibrationDataVector pdCalibrationDataVector);

    public static final native long GoudaStaticMetadata_calibration_landscape_right_get(long j, GoudaStaticMetadata goudaStaticMetadata);

    public static final native void GoudaStaticMetadata_calibration_landscape_right_set(long j, GoudaStaticMetadata goudaStaticMetadata, long j2, PdCalibrationDataVector pdCalibrationDataVector);

    public static final native long GoudaStaticMetadata_calibration_portrait_get(long j, GoudaStaticMetadata goudaStaticMetadata);

    public static final native void GoudaStaticMetadata_calibration_portrait_set(long j, GoudaStaticMetadata goudaStaticMetadata, long j2, PdCalibrationDataVector pdCalibrationDataVector);

    public static final native String GoudaStaticMetadata_stereo_pipeline_config_get(long j, GoudaStaticMetadata goudaStaticMetadata);

    public static final native void GoudaStaticMetadata_stereo_pipeline_config_set(long j, GoudaStaticMetadata goudaStaticMetadata, String str);

    public static final native boolean GoudaSwigWrapper_Init(long j, GoudaSwigWrapper goudaSwigWrapper, long j2);

    public static final native boolean GoudaSwigWrapper_Process(long j, GoudaSwigWrapper goudaSwigWrapper, long j2, long j3, GoudaCallbacks goudaCallbacks, long j4, InterleavedReadViewU8 interleavedReadViewU8, long j5, GoudaDepthArguments goudaDepthArguments, long j6, long j7, GoudaRequest goudaRequest);
    ...
    public static final native boolean IsEaselNative(int i);

    public static final native boolean IsIpuCoarseGrain(int i);

    public static final native boolean IsIpuFineGrain(int i);
    ...
    public static final native void PdCalibrationDataVector_add(long j, PdCalibrationDataVector pdCalibrationDataVector, long j2, PdCalibrationData pdCalibrationData);

    public static final native long PdCalibrationDataVector_capacity(long j, PdCalibrationDataVector pdCalibrationDataVector);

    public static final native void PdCalibrationDataVector_clear(long j, PdCalibrationDataVector pdCalibrationDataVector);

    public static final native long PdCalibrationDataVector_get(long j, PdCalibrationDataVector pdCalibrationDataVector, int i);

    public static final native boolean PdCalibrationDataVector_isEmpty(long j, PdCalibrationDataVector pdCalibrationDataVector);

    public static final native void PdCalibrationDataVector_reserve(long j, PdCalibrationDataVector pdCalibrationDataVector, long j2);

    public static final native void PdCalibrationDataVector_set(long j, PdCalibrationDataVector pdCalibrationDataVector, int i, long j2, PdCalibrationData pdCalibrationData);

    public static final native long PdCalibrationDataVector_size(long j, PdCalibrationDataVector pdCalibrationDataVector);

    public static final native float PdCalibrationData_depth_to_disparity_offset_get(long j, PdCalibrationData pdCalibrationData);

    public static final native void PdCalibrationData_depth_to_disparity_offset_set(long j, PdCalibrationData pdCalibrationData, float f);

    public static final native float PdCalibrationData_depth_to_disparity_scale_get(long j, PdCalibrationData pdCalibrationData);

    public static final native void PdCalibrationData_depth_to_disparity_scale_set(long j, PdCalibrationData pdCalibrationData, float f);

    public static final native float PdCalibrationData_estimated_focus_distance_diopters_get(long j, PdCalibrationData pdCalibrationData);

    public static final native void PdCalibrationData_estimated_focus_distance_diopters_set(long j, PdCalibrationData pdCalibrationData, float f);

    public static final native long PdCalibrationData_pd_offset_get(long j, PdCalibrationData pdCalibrationData);

    public static final native void PdCalibrationData_pd_offset_set(long j, PdCalibrationData pdCalibrationData, long j2, InterleavedImageF interleavedImageF);

    public static final native long PdCalibrationData_pd_scale_get(long j, PdCalibrationData pdCalibrationData);

    public static final native void PdCalibrationData_pd_scale_set(long j, PdCalibrationData pdCalibrationData, long j2, InterleavedImageF interleavedImageF);

    public static final native float PdCalibrationData_reported_focus_distance_diopters_get(long j, PdCalibrationData pdCalibrationData);

    public static final native void PdCalibrationData_reported_focus_distance_diopters_set(long j, PdCalibrationData pdCalibrationData, float f);
    ...
    public static final native boolean RawFinishParams_debias_get(long j, RawFinishParams rawFinishParams);

    public static final native void RawFinishParams_debias_set(long j, RawFinishParams rawFinishParams, boolean z);
    ...
    public static final native long RawFinishParams_low_frequency_denoise_get(long j, RawFinishParams rawFinishParams);

    public static final native void RawFinishParams_low_frequency_denoise_set(long j, RawFinishParams rawFinishParams, long j2);
    ...
    public static final native boolean ReadJpgMetadata__SWIG_0(String str, long j, ExifMetadata exifMetadata);

    public static final native boolean ReadJpgMetadata__SWIG_1(long j, long j2, long j3, ExifMetadata exifMetadata);

    public static final native long ReadJpg__SWIG_0(String str, long j, ExifMetadata exifMetadata);

    public static final native long ReadJpg__SWIG_1(String str);

    public static final native long ReadJpg__SWIG_2(long j, long j2, long j3, ExifMetadata exifMetadata);

    public static final native long ReadJpg__SWIG_3(long j, long j2);
    ...
    public static final native boolean RotateJpg(long j, long j2, int i, long j3, long[] jArr);
    ...
    public static final native String SerializeDngMakernoteToString__SWIG_0(long j, InitParams initParams, long j2, StaticMetadata staticMetadata, long j3, ShotParams shotParams, long j4, FrameMetadata frameMetadata);

    public static final native void SerializeDngMakernoteToString__SWIG_1(long j, InitParams initParams, long j2, StaticMetadata staticMetadata, long j3, ShotParams shotParams, long j4, FrameMetadata frameMetadata, long j5);
    ...
    public static final native float ShotParams_max_tripod_shot_capture_time_ms_get(long j, ShotParams shotParams);

    public static final native void ShotParams_max_tripod_shot_capture_time_ms_set(long j, ShotParams shotParams, float f);
    ...
    public static final native boolean ShotParams_tripod_detection_enabled_get(long j, ShotParams shotParams);

    public static final native void ShotParams_tripod_detection_enabled_set(long j, ShotParams shotParams, boolean z);
    ...
    public static void SwigDirector_EncodedBlobCallback_Run(EncodedBlobCallback encodedBlobCallback, int i, long j, long j2, int i2, int i3) {
        encodedBlobCallback.Run(i, j != 0 ? new SWIGTYPE_p_unsigned_char(j, false) : null, j2, i2, i3);
    }
    ...
    public static void SwigDirector_RawImageCallback_ImageReady(RawImageCallback rawImageCallback, int i, long j, long j2) {
        rawImageCallback.ImageReady(i, new ExifMetadata(j, false), j2 != 0 ? new RawImage(j2, false) : null);
    }
    ...
    public static final native long Tuning_GetExtraFinishVignetting(long j, Tuning tuning, int i);
    ...
    public static final native long Tuning_GetPayloadBurstTetModel__SWIG_0(long j, Tuning tuning, int i, float f);

    public static final native long Tuning_GetPayloadBurstTetModel__SWIG_1(long j, Tuning tuning, int i);
    ...
    public static final native boolean ViewfinderProcessingOptions_process_ae_get(long j, ViewfinderProcessingOptions viewfinderProcessingOptions);

    public static final native void ViewfinderProcessingOptions_process_ae_set(long j, ViewfinderProcessingOptions viewfinderProcessingOptions, boolean z);
    ...
    public static final native boolean WriteJpgToMemory__SWIG_0(long j, long[] jArr, long j2, InterleavedReadViewU8 interleavedReadViewU8, long j3, JpgEncodeOptions jpgEncodeOptions);

    public static final native boolean WriteJpgToMemory__SWIG_1(long j, long[] jArr, long j2, YuvReadView yuvReadView, long j3, JpgEncodeOptions jpgEncodeOptions);

    public static final native boolean WriteJpg__SWIG_0(String str, long j, InterleavedReadViewU8 interleavedReadViewU8, long j2, JpgEncodeOptions jpgEncodeOptions);

    public static final native boolean WriteJpg__SWIG_1(String str, long j, YuvReadView yuvReadView, long j2, JpgEncodeOptions jpgEncodeOptions);
    ...
    public static final native void delete_DebiasParams(long j);

    public static final native void delete_DebiasParams_Point(long j);
    ...
    public static final native void delete_GoudaBlobCallback(long j);
    ...
    public static final native void delete_GoudaDepthArguments(long j);
    ...
    public static final native void delete_GoudaSegmenterSwigWrapper(long j);

    public static final native void delete_GoudaStaticMetadata(long j);
    ...
    public static final native void delete_PdCalibrationData(long j);

    public static final native void delete_PdCalibrationDataVector(long j);
    ...
    public static final native int kDebiasCurveChannels_get();

    public static final native int kDebiasCurveSize_get();
    ...
    public static final native int kLegacySensorIdQuaternary_get();

    public static final native int kLegacySensorIdSecondary_get();

    public static final native int kLegacySensorIdTertiary_get();
    ...
    public static final native long new_DebiasParams();

    public static final native long new_DebiasParams_Point();
    ...
    public static final native long new_GoudaDepthArguments();
    ...
    public static final native long new_GoudaSegmenterSwigWrapper();

    public static final native long new_GoudaStaticMetadata();
    ...
    public static final native long new_InterleavedImageF__SWIG_6(int i, int i2, int i3, long j, long j2, long j3);

    public static final native long new_InterleavedImageF__SWIG_7(long j, InterleavedImageF interleavedImageF);
    ...
    public static final native long new_InterleavedReadViewF__SWIG_4(int i, int i2, int i3, long j, long j2);
    ...
    public static final native long new_InterleavedWriteViewF__SWIG_4(int i, int i2, int i3, long j, long j2);
    ...
    public static final native long new_PdCalibrationData();

    public static final native long new_PdCalibrationDataVector__SWIG_0();

    public static final native long new_PdCalibrationDataVector__SWIG_1(long j);
