...
public class FrameMetadata {
    ...
    public StringVector getCapture_errors() {
        ...
        if (FrameMetadata_capture_errors_get != 0) {
            return new StringVector(FrameMetadata_capture_errors_get, false);
        }
        return null;
    }
    ...
    public StringVector getCapture_warnings() {
        ...
        if (FrameMetadata_capture_warnings_get != 0) {
            return new StringVector(FrameMetadata_capture_warnings_get, false);
        }
        return null;
    }
